                    ...
                    <div class="tab-content">
                        ...
                        <?php if ($data['department'] == "Computer Science") : ?>
                            ...
                            <?php if ($data['level'] == "300 Level") : ?>
                                <?php foreach ($me as $course) :
                                    $department = $course["Department"];
                                    $level = $course["level"];
                                    if ($department == "Computer Science" && $level == "300 Level") :
                                ?>
                                        <div class="tab-pane container-fluid fade border rounded" data-bs-toggle="tab" id="courses">
                                            ...
                                            <ul class="nav nav-tabs d-flex" id="linkCarrier">
                                                <li class="nav-item m-3" id="linkList">
                                                    <button type="button" id="linkbtn" class="btn-secondary p-2 border-0 d-flex rounded text-dark">
                                                        <a class="nav-link" id="link">
                                                            <small class="w-50">
